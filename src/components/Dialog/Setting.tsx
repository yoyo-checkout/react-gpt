    ...
    <Transition appear show={visible} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={closeDialog}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-black/50 dark:bg-black/80"></div>
        </Transition.Child>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="grid h-full w-full grid-cols-[10px_1fr_10px] overflow-y-auto grid-rows-[minmax(10px,_1fr)_auto_minmax(10px,_1fr)] md:grid-rows-[minmax(20px,_1fr)_auto_minmax(20px,_1fr)]">
            ...
            >
              <Dialog.Panel className="popover relative left-1/2 col-auto col-start-2 row-auto row-start-2 w-full -translate-x-1/2 rounded-xl bg-token-main-surface-primary text-left shadow-xl transition-all flex flex-col focus:outline-none md:max-w-[680px]">
                ...
                <div className="flex-grow overflow-y-auto">
                  <div className="flex flex-col gap-6 md:flex-row">
                    <div
                      role="tablist"
                      className="outline-none m-2 md:m-0 md:px-4 md:pl-6 md:pt-4 flex flex-shrink-0 md:ml-[-8px] md:min-w-[180px] max-w-[200px] flex-col gap-2"
                    >
                      <button
                        className={`${
                          tab === 'general'
